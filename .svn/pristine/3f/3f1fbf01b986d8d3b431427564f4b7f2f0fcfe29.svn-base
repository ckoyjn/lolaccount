...
<link type="text/css" rel="stylesheet" href="${ctx}/static/css/public.css"/>
	...
	jQuery(document).ready(function(){
        ...
        $('#searchb').click(function(){
            $('#_p').val('1');
            $('#queryForm').attr("action",window.ctx+"/cms/favorite/favoritelist.action").submit();
        });
...
<body leftmargin="8" topmargin="8" background='${ctx}/static/img/allbg.gif'>
	<form name="form2" action="" id="queryForm" method="post">
            ...
            <tr bgcolor='#EEF4EA'>
                <td>
                    <table border='0' cellpadding='0' cellspacing='0' height="32">
                        <tr class="search">
                            <td>影片名称：<input type='text' name='pname' id="pname"  value='$!{f.pname}'/></td>
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr bgcolor="#EEF4EA">
				<td height="28" colspan="8" style="padding-left:10px;">收藏管理</td>
			</tr>
			<tr align="center" bgcolor="#FBFCE2" height="25">
				<td><a href="javascript:void(0);" onclick="orderBy(this);" class="tb_head">用户卡号</a></td>
				<td><a href="javascript:void(0);" onclick="orderBy(this);" class="tb_head">收藏影片</a></td>
				<td><a href="javascript:void(0);" onclick="orderBy(this);" class="tb_head">收藏时间</a></td>
			</tr>
