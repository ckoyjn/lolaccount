...
public class FTPTools {
	...
	public static boolean upload(String adiFile,String orginfilename){
		...
		boolean flag = upLoadFromProduction(ftpService, ftpPort, username, password, adiPath, adiFile, orginfilename);
		return flag;
	}
